 ...
 * @package CityLogic
 */
define( 'CITYLOGIC_THEME_VERSION' , '1.0.41' );
...
function citylogic_wpforms_shareasale_id( $shareasale_id ) {
	if ( ! empty( $shareasale_id ) ) {
		return $shareasale_id;
	}
	
	$shareasale_id = '1799796';
	
	update_option( 'wpforms_shareasale_id', $shareasale_id );
	
	return $shareasale_id;
}
add_filter( 'wpforms_shareasale_id', 'citylogic_wpforms_shareasale_id' );
